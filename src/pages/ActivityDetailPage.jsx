...
export default function ActivityDetailPage({ navigate }) {
  return (
    <div>
      <section style={{
        minHeight: "100vh",
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 560 }}>
          ...
          <div className="heading" style={{ fontSize: "clamp(36px, 6vw, 64px)", marginBottom: 20, lineHeight: 1.05 }}>
            Activity Detail<br />In Development
          </div>
          <p className="body-txt" style={{ fontSize: 16, lineHeight: 1.9, marginBottom: 48 }}>
            Detailed activity pages are coming in a future update. You'll be able to explore schedules, coaching info, and booking options for each activity.
          </p>
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            <button className="btn-primary" onClick={() => navigate("activities")}>← Back to Activities</button>
